...
abstract class Pawn extends Robot {
    ...
    protected Direction awayFromRobots(ArrayList<RobotInfo> robots) throws GameActionException {
    ...
    protected Direction awayFromAllies() throws GameActionException {
        return awayFromRobots(new ArrayList<>(Arrays.asList(rc.senseNearbyRobots(sensorRadiusSquared, allyTeam))));
    }
}
