...
public class Constants {
    ...
    public static final int minimumPolInf = 12;
    public static final RobotType[] spawnOrder = {RobotType.MUCKRAKER,RobotType.MUCKRAKER,RobotType.SLANDERER,RobotType.MUCKRAKER,RobotType.MUCKRAKER,RobotType.POLITICIAN,RobotType.MUCKRAKER,RobotType.POLITICIAN,RobotType.POLITICIAN,RobotType.POLITICIAN};
}
